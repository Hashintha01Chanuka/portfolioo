        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-left">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              I am an undergraduate pursuing a Computer Science degree,
              passionate about building scalable and impactful software
              solutions.
            </p>
            <p className="text-gray-300">
              I have hands-on experience with full-stack technologies including
              MERN, Spring Boot with React, and Laravel, which allow me to work
              across both frontend and backend effectively.
            </p>
            <p className="text-gray-300">
              As a self-learner, I am eager to grow with technology, collaborate
              with others, and contribute to creating meaningful software that
